...
public abstract class BasePolicyKey<M extends BasePolicyKey<M>> extends Model<M> implements IBean {
	 ...
	 * 关键词列表
	 */
	public void setKeyList(java.lang.String keyList) {
		set("key_list", keyList);
	}
